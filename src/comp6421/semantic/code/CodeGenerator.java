...
public class CodeGenerator {
	...
	private void generateProgram(FunctionEntry program) throws SemanticException {
		...
		c.appendInstruction(new AddWordImmediateInstruction(Register.STACK_POINTER, Register.STACK_POINTER,
	...
	private void generateFunction(FunctionEntry func) throws SemanticException {
		...
		c.appendInstruction(
				new AddWordImmediateInstruction(Register.STACK_POINTER, Register.STACK_POINTER, -1 * s.getSize())
						.setComment("reset stack pointer"));
		c.appendInstruction(new JumpRegisterInstruction(pcRegister).setComment("return"));
